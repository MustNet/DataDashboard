...
# GitHub URL für das Repository und die Dateien
GITHUB_FILE_URL = "https://raw.githubusercontent.com/MustNet/DataDashboard/main/Auftragsübersicht.xlsx"
...
# Funktion, um eine Datei von GitHub herunterzuladen
...
# Lade die Datei von GitHub und zeige sie im Uploader an
st.sidebar.write("Wählen Sie die Datei aus, die Sie anzeigen möchten.")
if st.sidebar.button("Datei von GitHub laden"):
    file_bytes = download_file(GITHUB_FILE_URL)
    
    if file_bytes:
        uploaded_file = st.sidebar.file_uploader("Bestätigen Sie die Datei", type=["xlsx"], key="file1", value=file_bytes)
